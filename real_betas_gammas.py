...
if __name__=="__main__":
    for n in range(Min,Max):
        ...
        if 'max_chsh_test_real1.pi' in os.listdir(): # Stores in filename "max_chsh_eig.pi"
            with open('max_chsh_test_real1.pi','rb') as f:
                d = load(f)
                ...
                # or optimization result is better than previous iteration.
                    d[n] = o
                    with open('max_chsh_test_real1.pi','wb') as f:
                        dump(d,f)
        else:
